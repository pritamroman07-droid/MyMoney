  ...
  if (!editing && budget) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-xl p-3 sm:p-4 border border-gray-100 dark:border-gray-700">
        <h2 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3">Monthly Budget</h2>
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 py-2 sm:py-2.5 rounded-lg font-medium hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors text-sm"
          >
            Edit Budget
          </button>
          <button
            onClick={handleDelete}
            className="px-3 py-2 sm:py-2.5 text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors text-sm"
          >
            Delete
          </button>
        </div>
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-3 sm:p-4 border border-gray-100 dark:border-gray-700">
      ...
      <div className="space-y-3">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="0"
              className="w-full pl-7 sm:pl-8 pr-3 sm:pr-4 py-2.5 sm:py-3 border border-gray-200 dark:border-gray-600 rounded-lg text-base sm:text-lg font-medium bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent"
            />
          </div>
        </div>
        ...
        <div className="flex gap-2">
          ...
          {budget && (
            <button
              ...
              className="px-4 py-2.5 sm:py-3 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors text-sm"
            >
              Cancel
            </button>
          )}
        ...
        {success && (
          <p className="text-violet-600 dark:text-violet-400 text-xs text-center">{success}</p>
        )}
      </div>
    </div>
  )
