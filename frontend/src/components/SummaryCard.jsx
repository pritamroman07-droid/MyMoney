export default function SummaryCard({ title, amount, icon, color }) {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-3 sm:p-4 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow min-w-0">
      ...
      <p className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white truncate">{amount}</p>
    </div>
  )
}
